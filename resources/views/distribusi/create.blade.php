    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tambah Data Distribusi</h3>
        </div>
        <div class="card-body">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label">Copy-an Ke-</label>
                <input type="text" class="form-control" name="copyFile" placeholder="Copy-an">
            </div>
        </div>
        <div class="card-footer">
            <div class="d-flex">
              <a href="/distribusi" class="btn btn-link">Cancel</a>
